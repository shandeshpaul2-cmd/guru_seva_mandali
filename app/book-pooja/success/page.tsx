...
import { CheckCircle, Home, ArrowLeft, Calendar, Phone, MapPin } from 'lucide-react'
...
function BookingSuccessContent() {
  ...
  useEffect(() => {
    ...
    const storedDetails = sessionStorage.getItem('poojaBookingDetails')
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="text-center mb-6">
              <h1 className="font-cinzel text-2xl sm:text-3xl font-bold text-temple-maroon mb-2">
                🕉️ 🕉️ Pooja Booking Confirmed!
              </h1>
              <p className="text-gray-600 mb-2">
                Your pooja booking has been successfully received
              </p>
            ...
            <div className="bg-orange-50 rounded-xl p-4 border border-temple-gold/30 mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-start">
                  <span className="text-gray-600 text-sm">Pooja Service:</span>
                ...
                {bookingDetails.preferredDate && (
                  <div className="flex justify-between items-start">
                    <span className="text-gray-600 text-sm">Preferred Date:</span>
                    <span className="font-medium text-temple-maroon text-sm text-right">
                      {new Date(bookingDetails.preferredDate).toLocaleDateString('en-IN')}
                    </span>
                  </div>
                )}
                {bookingDetails.preferredTime && (
                  <div className="flex justify-between items-start">
                    ...
                    <span className="font-medium text-temple-maroon text-sm text-right">{bookingDetails.preferredTime}</span>
                  </div>
                )}
                <div className="flex justify-between items-start">
            ...
            <div className="space-y-3">
              ...
              <Link href="/book-pooja" className="block">
