...
export const metadata = {
  title: 'Terms & Conditions | Shri Raghavendra Swamy Brundavana Sannidhi',
  description: 'Terms & Conditions for Shri Raghavendra Swamy Brundavana Sannidhi',
}
          ...
          <div className="px-6 py-8 sm:px-8 space-y-6 text-gray-700">
            ...
            <section>
              <p className="leading-relaxed">
                Welcome to Shri Raghavendra Swamy Brundavana Sannidhi's online platform. These Terms and
                Conditions ("Terms") govern your use of our website and services for donations, pooja bookings,
                and astrology consultations. By using our platform, you agree to these Terms.
              </p>
            </section>
